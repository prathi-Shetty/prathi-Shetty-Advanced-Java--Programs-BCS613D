...
/**
 * Servlet implementation class FactorialCalculatorServlet
 * This servlet calculates the factorial of a number submitted via an HTML form,
 * validates the input, and displays the calculation steps along with the result.
 */
...
public class FactorialCalculatorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Input validation: number should be non-negative and not too large to avoid overflow
            if (number < 0) {
            ...
            // Calculate factorial and build calculation steps string
            long factorial = 1;
            ...
            if (number == 0 || number == 1) {
                ...
                factorial *= 1; // Multiplying by 1 to keep logic consistent (optional)
                calculation += " = " + factorial;
            }

            // Generate HTML response displaying the result and steps
            out.println("<html>");
            out.println("<head>");
    ...
    // Redirect GET requests to the HTML form page
